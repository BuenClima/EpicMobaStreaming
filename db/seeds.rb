...
Streamer.create(twitch_user_id: 123455, twitch_username: 'Streamer1', twitch_channel_url: 'Canal1', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(twitch_user_id: 123456, twitch_username: 'Streamer2', twitch_channel_url: 'Canal2', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(twitch_user_id: 123457, twitch_username: 'Streamer3', twitch_channel_url: 'Canal3', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(twitch_user_id: 123458, twitch_username: 'Streamer4', twitch_channel_url: 'Canal4', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(twitch_user_id: 123459, twitch_username: 'Streamer5', twitch_channel_url: 'Canal5', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(twitch_user_id: 123450, twitch_username: 'Streamer6', twitch_channel_url: 'Canal6', name: 'Algun', lastname: 'nombre', birthday: Date.today, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))