...
a = Player.create(position: 'Top', origin: 'Korea', image: '/null/', name: 'Uno', biography: 'Uno', nick: 'Untara', team: Team.where('name' => 'SKT').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
b = Player.create(position: 'Mid', origin: 'Korea', image: '/null/', name: 'Dos', biography: 'Dos', nick: 'Blank', team: Team.where('name' => 'SKT').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
c = Player.create(position: 'Jungle', origin: 'Korea', image: '/null/', name: 'Tres', biography: 'Tres', nick: 'Faker', team: Team.where('name' => 'SKT').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
d = Player.create(position: 'ADC', origin: 'Korea', image: '/null/', name: 'Cuatro', biography: 'Cuatro', nick: 'Bang', team: Team.where('name' => 'SKT').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
e = Player.create(position: 'Support', origin: 'Korea', image: '/null/', name: 'Cinco', biography: 'Cinco', nick: 'Wolf', team: Team.where('name' => 'SKT').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))

f = Player.create(position: 'Top', origin: 'Korea', image: '/null/', name: 'Seis', biography: 'Seis', nick: 'Acorn', team: Team.where('name' => 'SSB').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
g = Player.create(position: 'Mid', origin: 'Korea', image: '/null/', name: 'Siete', biography: 'Siete', nick: 'Spirit', team: Team.where('name' => 'SSB').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
h = Player.create(position: 'Jungle', origin: 'Korea', image: '/null/', name: 'Ocho', biography: 'Ocho', nick: 'Heart', team: Team.where('name' => 'SSB').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
i = Player.create(position: 'ADC', origin: 'Korea', image: '/null/', name: 'Nueve', biography: 'Nueve', nick: 'Dade', team: Team.where('name' => 'SSB').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
j = Player.create(position: 'Support', origin: 'Korea', image: '/null/', name: 'Diez', biography: 'Diez', nick: 'Deft', team: Team.where('name' => 'SSB').first, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
...
Streamer.create(image: '/null', twitch_user_id: 123455, twitch_username: 'Streamer1', twitch_channel_url: 'Canal1', name: 'Algun', streamer_type: 1, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123456, twitch_username: 'Streamer2', twitch_channel_url: 'Canal2', name: 'Algun', streamer_type: 1, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123457, twitch_username: 'Streamer3', twitch_channel_url: 'Canal3', name: 'Algun', streamer_type: 2, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123458, twitch_username: 'Streamer4', twitch_channel_url: 'Canal4', name: 'Algun', streamer_type: 2, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123459, twitch_username: 'Streamer5', twitch_channel_url: 'Canal5', name: 'Algun', streamer_type: 3, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123450, twitch_username: 'Streamer6', twitch_channel_url: 'Canal6', name: 'Algun', streamer_type: 3, game: lol, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
Streamer.create(image: '/null', twitch_user_id: 123451, twitch_username: 'Streamer7', twitch_channel_url: 'Canal6', name: 'Algun', streamer_type: 3, game: hots, created_at: Time.now.strftime('%d/%m/%Y %H:%M'), updated_at: Time.now.strftime('%d/%m/%Y %H:%M'))
