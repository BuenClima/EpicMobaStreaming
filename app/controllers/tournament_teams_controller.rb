class TournamentTeamsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tournament_team.save
        format.html { redirect_to @tournament_team, notice: 'Tournament team was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tournament_team.update(tournament_team_params)
        format.html { redirect_to @tournament_team, notice: 'Tournament team was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tournament_teams_url, notice: 'Tournament team was successfully destroyed.' }
  ...
  private
    ...
    def tournament_team_params
      params.require(:tournament_team).permit(:tournament_id, :team_id, :created_at, :updated_at)
    end
end
