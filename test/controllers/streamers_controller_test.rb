...
class StreamersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create streamer" do
    assert_difference('Streamer.count') do
      post streamers_url, params: { streamer: { created_at: @streamer.created_at, game_id: @streamer.game_id, image: @streamer.image, name: @streamer.name, streamer_type: @streamer.streamer_type, twitch_channel_url: @streamer.twitch_channel_url, twitch_user_id: @streamer.twitch_user_id, twitch_username: @streamer.twitch_username, update_at: @streamer.update_at } }
    end
