...
class TournamentTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament_team" do
    assert_difference('TournamentTeam.count') do
      post tournament_teams_url, params: { tournament_team: { created_at: @tournament_team.created_at, team_id: @tournament_team.team_id, tournament_id: @tournament_team.tournament_id, updated_at: @tournament_team.updated_at } }
    end
  ...
  test "should update tournament_team" do
    patch tournament_team_url(@tournament_team), params: { tournament_team: { created_at: @tournament_team.created_at, team_id: @tournament_team.team_id, tournament_id: @tournament_team.tournament_id, updated_at: @tournament_team.updated_at } }
